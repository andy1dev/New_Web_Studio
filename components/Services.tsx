...
const services = [
  {
    ...
    description: 'Construimos sitios y apps con React, Next.js y Node.js sin plantillas, sin atajos. Cada línea pensada para escalar contigo.',
  ...
  },
  {
    ...
    description: 'Tiendas online optimizadas para conversión. Pasarelas locales, inventario y experiencia impecable.',
    tags: [],
    size: 'tall' as const,
    pos: 1,
  },
  {
    ...
    description: 'Posicionamiento orgánico real. Lighthouse 90+. Que Google y tus clientes te encuentren.',
    tags: [],
    size: 'wide' as const,
    pos: 2,
    stat: '90+',
  ...
  },
  {
    ...
    description: 'Facturación electrónica SRI, ERP a medida y plataformas Moodle / LMS.',
    tags: [],
  ...
  },
  {
    ...
    size: 'square' as const,
    pos: 5,
    statLabel: 'Proyectos a 4 países',
    isStat: true,
  },
]
